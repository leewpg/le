...
class SimpleAuth {
    ...
    updateReferralPage() {
        ...
        if (referralDesc) {
            referralDesc.textContent = `Share code "${this.currentUser.referral_code}" with friends and earn ৳4500 when they join! and your freind will get ৳3000`;
        }
    }
        ...
        if (bonusSections.length > 1) {
            ...
            bonusSection.innerHTML = `
                ...
                <div class="reward-card">
                    ...
                    <button class="play-btn" style="margin-top: 10px; padding: 8px 15px;" onclick="claimBonus('xbirthday')">CLAIM</button>
                </div>
                <div class="reward-card">
                    <i class="fas fa-calendar reward-icon"></i>
                    <div class="stat-value">৳100</div>
                    <div class="stat-label">Weekly Bonus</div>
                    <button class="play-btn" style="margin-top: 10px; padding: 8px 15px;" onclick="claimBonus('xweekly')">CLAIM</button>
                </div>
                <div class="reward-card">
                    <i class="fas fa-share reward-icon"></i>
                    <div class="stat-value">৳4500</div>
                    <div class="stat-label">Referral Bonus</div>
                    <button class="play-btn" style="margin-top: 10px; padding: 8px 15px;" onclick="claimBonus('xreferral')">CLAIM</button>
                </div>
            `;
